---
  title: Chord Café
  summary: This e-commerce app allows users to purchase music courses seamlessly. Built with Next.js and TailwindCSS for a responsive interface, it uses Prisma and PostgreSQL for efficient data management. Stripe handles secure payments, while Resend sends automated email notifications, providing users with a smooth and engaging learning experience.
